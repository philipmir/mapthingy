/**
 * Global Machine Monitor - Modern Flat Design
 * 
 * Modern flat design with vibrant colors, clean typography, and smooth animations
...
// Modern flat custom machine status icons
const createCustomIcon = (status, systemType, machineId, recentlyChanged) => {
  let color;
  let shape = 'circle';
  let size = 18;
  
  // Set color based on status - vibrant flat colors
  switch (status) {
    case 'online':
      color = '#22c55e';
      break;
...
function AppModern() {
  ...
  const styles = [
    ...
    { id: 'modern', name: 'Modern', component: null }
  ];
  ...
  return (
    <AppContainer>
      ...
      <MapWrapper>
        ...
        <StatusPanel>
          <h4 style={{ margin: '0 0 1.25rem 0', color: '#0f172a', fontWeight: '600' }}>Machine Status</h4>
          <div style={{ marginBottom: '1.25rem', fontSize: '0.9rem', color: '#64748b', fontWeight: '500' }}>
            Connection: <span style={{ color: connectionStatus === 'Connected' ? '#22c55e' : '#ef4444' }}>{connectionStatus}</span>
          </div>
          ...
          <div style={{ marginTop: '1.5rem', paddingTop: '1.25rem', borderTop: '1px solid #e2e8f0' }}>
            <h5 style={{ margin: '0 0 0.75rem 0', color: '#0f172a', fontSize: '0.9rem', fontWeight: '600' }}>System Types:</h5>
            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '0.75rem' }}>
              ...
              <span style={{ fontSize: '0.85rem', color: '#64748b', fontWeight: '500' }}>Automated System 4000</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center' }}>
              ...
              <span style={{ fontSize: '0.85rem', color: '#64748b', fontWeight: '500' }}>Mini-System 4000</span>
            </div>
          </div>
        </StatusPanel>
      </MapWrapper>
